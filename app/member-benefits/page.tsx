    ...
    return (
        <div>
            ...
            <div className="flex w-11/12 mx-auto my-5">
                ...
                <div className="transition ease-in-out duration-200 block border-indigo-600 border-2 bg-slate-100 lg:rounded-lg md:rounded-md p-10 shadow-lg shadow-indigo-600 text-slate-900 w-full">
