...
export default function MemberBenefits() {
    const addService = (
        <div className="w-full border-2 transition ease-in-out mb-6 hover:shadow-lg hover:shadow-indigo-600 hover:border-indigo-500 block p-6 rounded-lg text-white shadow bg-slate-900 border-gray-700">
            ...
            <div className="h-8 mb-2 p-2 border rounded-lg items-center justify-center inline-flex border-green-500 text-green-500">
              Done
            </div>
          </div>
            ...
            <div className="relative border-2 group transition ease-in-out shadow-lg shadow-indigo-600 border-indigo-500 block p-6 rounded-lg bg-slate-900">
                <div className='flex'>
                    <div className="w-full items-center justify-between text-white">
                        <input className="w-full mb-2 pr-6 text-2xl tracking-tight font-bold bg-transparent focus:outline-none" placeholder="Type a new service name here..."/>
                    </div>
                ...
                <div className="flex items-center w-full mt-4 justify-between rounded-lg text-gray-300 bg-slate-800">
                    <input className="w-full bg-transparent px-4 py-1 focus:outline-none" placeholder="Link of source to add..."/>
    ...
    const instantCHecker = (
        <div className="w-full border-2 transition ease-in-out mb-6 hover:shadow-lg hover:shadow-indigo-600 hover:border-indigo-500 block p-6 rounded-lg text-white shadow bg-slate-900 border-gray-700">
          <div className="flex justify-between">
            ...
            <div className="h-8 mb-2 p-2 border rounded-lg items-center justify-center inline-flex border-orange-500 text-orange-500">
              Coming Soon
            </div>
          </div>
          <p className="font-bold tracking-tight mb-5">
    ...
    const preferences = (
        <div className="w-full border-2 transition ease-in-out mb-6 hover:shadow-lg hover:shadow-indigo-600 hover:border-indigo-500 block p-6 rounded-lg text-white shadow bg-slate-900 border-gray-700">
          <div className="flex justify-between">
            ...
            <div className="h-8 mb-2 p-2 border rounded-lg items-center justify-center inline-flex border-yellow-500 text-yellow-500">
              In Testing
            </div>
          </div>
          <p className="font-bold tracking-tight mb-5">
            ...
            <div className="block lg:flex w-11/12 mx-auto my-5">
                <div className="flex w-full lg:w-1/2 justify-center items-center lg:min-h-[var(--custom-max-height)]">
                    <div className="text-center p-5">
                        ...
                        <a href="#"><button className="rounded-lg transition ease-in-out duration-300 labil font-semibold w-full p-4 bg-slate-100 text-slate-900 my-2 lg:my-5 border-2 border-slate-100 hover:text-slate-100 hover:bg-slate-900 hover:shadow-lg hover:shadow-indigo-600">Contact</button></a>
                    </div>
                </div>
