export default function Card(props: any) {
  ...
  return (
    <a href="#" className="transition ease-in-out mb-7 hover:shadow-lg hover:shadow-emerald-600 block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-slate-900 dark:border-gray-700">
