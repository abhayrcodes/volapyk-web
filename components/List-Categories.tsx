        ...
        <div>
            {initialCategories.map((category, index) => (
                <div key={index} className="mb-6">
                    <div className="flex p-2 items-center transition ease-in-out duration-200 text-white cursor-pointer text-xl border-2 border-transparent" onClick={() => toggleCategory(category)}>
                    ...
                    {openCategories.includes(category) && (
                        <div className='rounded-lg border-2 border-slate-800 mt-3 p-2'>
