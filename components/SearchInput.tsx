    ...
    return (
        <div>
            <div className="pointer-events-none text-center mt-20">
                ...
                <p className="text-md md:text-lg text-gray-400 lg:text-2xl">Keeping you safe, <span className="underline decoration-purple-600">one sentence at a time.</span></p>
            </div>
