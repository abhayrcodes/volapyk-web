    ...
    return (
        <div>
            <div className="pointer-events-none text-center mt-20">
                ...
                <p className="labil text-md md:text-lg font-normal text-gray-400 lg:text-2xl">Keeping you safe, <span className="underline decoration-purple-600">one sentence at a time.</span></p>
            </div>
            ...
            <form className="w-5/6 mt-20 mb-10 m-auto" onSubmit={onSearch}>   
                ...
                <div className="relative">
                    ...
                    <input value = {searchQuery} onChange={(event) => setSearchQuery(event.target.value)} type="search" id="default-search" className="labil transition ease-in-out hover:shadow-lg hover:shadow-indigo-600 block w-full p-4 pl-10 text-sm border-2 rounded-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-slate-900 border-gray-600 placeholder-gray-400 text-white" placeholder="Search for a service here..." required></input>
