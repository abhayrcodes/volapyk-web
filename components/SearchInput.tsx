        ...
        <div>
            ...
            <form className="w-5/6 mt-20 mb-10 m-auto" onSubmit={onSearch}>   
                ...
                <div className="relative">
                    ...
                    <input value = {searchQuery} onChange={(event) => setSearchQuery(event.target.value)} type="search" id="default-search" className="transition ease-in-out hover:shadow-lg hover:shadow-emerald-600 block w-full p-4 pl-10 text-sm border rounded-lg focus:ring-emerald-500 focus:border-emerald-500 bg-slate-900 border-gray-600 placeholder-gray-400 text-white" placeholder="Search for a service here..." required></input>
