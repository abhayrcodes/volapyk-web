        ...
        <div className="flex flex-wrap items-center justify-between mx-10 p-4">
          ...
          <div className="hidden w-full lg:block lg:w-auto" id="navbar-default">
            <ul className="text-white font-semibold flex flex-col p-4 lg:p-0 mt-4 border rounded-lg lg:flex-row md:space-x-8 lg:mt-0 lg:border-0">
              ...
              <li>
                <Link href="/" className="block border-2 border-transparent bg-purple-600 rounded-lg hover:shadow-lg hover:shadow-indigo-600 bg-transparent p-2 hover:text-purple-600 hover:border-purple-600 hover:bg-purple-600 hover:bg-opacity-10 ease-in-out duration-150">Preferences</Link>
              </li>
              <li>
        ...
        <div className={`${isNavbarExpanded ? '' : 'hidden'}`}>
          <div>
            <ul className="text-white font-bold text-xl text-center mt-5">
              ...
              <li>
                <Link href="/" className="w-fit mx-auto mb-1 block border-2 border-transparent bg-purple-600 rounded-lg hover:shadow-lg hover:shadow-indigo-600 bg-transparent p-2 hover:text-purple-600 hover:border-purple-600 hover:bg-purple-600 hover:bg-opacity-10 ease-in-out duration-150">Preferences</Link>
              </li>
              <li>
      ...
      <div className="flex flex-wrap items-center justify-between mx-10 p-4">
        ...
        <div className="hidden w-full lg:block lg:w-auto" id="navbar-default">
          <ul className="text-white font-semibold flex flex-col p-4 lg:p-0 mt-4 border rounded-lg lg:flex-row md:space-x-8 lg:mt-0 lg:border-0">
            ...
            <li>
              <Link href="/" className="block border-2 border-transparent bg-purple-600 rounded-lg hover:shadow-lg hover:shadow-indigo-600 bg-transparent p-2 hover:text-purple-600 hover:border-purple-600 hover:bg-purple-600 hover:bg-opacity-10 ease-in-out duration-150">Member Benefits</Link>
            </li>
            <li>
      ...
      <div className={`${isNavbarExpanded ? '' : 'hidden'}`}>
        <div>
          <ul className="text-white font-bold text-xl text-center mt-5">
            ...
            <li>
              <Link href="/" className="w-fit mx-auto mb-1 block border-2 border-transparent bg-purple-600 rounded-lg hover:shadow-lg hover:shadow-indigo-600 bg-transparent p-2 hover:text-purple-600 hover:border-purple-600 hover:bg-purple-600 hover:bg-opacity-10 ease-in-out duration-150">Member Benefits</Link>
            </li>
            <li>
