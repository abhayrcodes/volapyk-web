          ...
          <div className="flex flex-wrap items-center justify-between mx-10 p-4">
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
              <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <Link href="#" className="block border-2 border-transparent text-white bg-purple-600 rounded bg-transparent p-2 hover:text-purple-600 hover:border-purple-600 hover:bg-purple-600 hover:bg-opacity-20 ease-in-out duration-150">Contact</Link>
                </li>
              </ul>
            </div>
          </div>
